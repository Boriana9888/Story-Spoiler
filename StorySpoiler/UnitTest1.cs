...
namespace StorySpoiler
{
    ...
    public class StorySpoilerTests
    {
        ...
        {
            
            string token = GetJwtToken("boryana931", "borry123borry123");
...
        private string GetJwtToken(string username, string password)
        ...
        [Test, Order(2)]
        public void EditStorySpoilerTitle_ShouldReturnOk()
        {
            var editedStory = new StoryDTO()
            {
                Title = "Edited Story",
                Description = "This is an updated story spoiler description.",
                Url = ""
            };
